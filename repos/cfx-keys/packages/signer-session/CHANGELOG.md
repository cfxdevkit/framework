...
- 13ce3f8: Add optional `includeCore` parameter to skip Core signer initialization and improve device connection reliability by serializing address probes.
...
- 2a1f21f: Refactored keystore CLI command handlers into modular subcommand files to reduce complexity.
  Removed OneKey hardware wallet backend implementation.
...
- 74e8c76: Internal test suite improvements for signer session.
- e44000a: Internal build system configuration updates.
  Internal build system configuration updates.
  Internal build system configuration updates.
  Internal build system configuration updates.
  Internal build system configuration updates.
...
- e7b1183: Added @noble/hashes as an optional dependency.
