...
- Added `outputs` declarations for `check-hotspots`, `check-docs`, and `check-corpus` tasks pointing to their respective artifact files under `artifacts/llm/reports/` and `artifacts/llm/corpus/`.
