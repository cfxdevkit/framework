/**
 * `TestToken` — a minimal ERC-20 with unrestricted public minting.
 * Intended for devnode testing and local development only.
 * Do NOT deploy to mainnet.
 */
export const TEST_TOKEN_PATH = 'cfxdevkit/TestToken.sol';
...
/**
 * @title TestToken
 * @notice Minimal ERC-20 with public mint — for local development only.
 *         Do NOT deploy to mainnet.
 */
contract TestToken {
    string public name;
