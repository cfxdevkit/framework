...
```tsx
import { Field, TokenAmountField } from '@cfxdevkit/ui/form';
...
```ts
// Props for metric display with optional delta.
export interface MetricProps {
  className?: string;
  delta?: string;
  deltaClassName?: string;
...
```tsx
import { Metric, SegmentedControl } from '@cfxdevkit/ui/data-display';
...
```ts
// Props for network switch notice.
export interface NetworkSwitchNoticeProps {
  addChainParams?: {
    chainId: string;
    chainName: string;
...
// Props for generic notice component.
export interface NoticeProps {
  children: React.ReactNode;
  className?: string;
  tone: NoticeTone;
...
<NetworkSwitchNotice
  ...
  message="Switch to Conflux Mainnet to continue."
/>
```
...
// Renders an accessible icon-only button with title tooltip.
export declare function IconButton({ title, children, ...props }: IconButtonProps): import("react/jsx-runtime").JSX.Element;
...
<WalletStatusChip address="0x1234..." status="connected" />

<WalletProviderCard
  title="MetaMask"
  status="active"
  account="0x1234..."
  chainLabel="Conflux Mainnet"
  onDisconnect={() => {}}
/>
```

{/* readme-hash: 43a31d0a0588a942aeb0b413a5aac958bd9c099bd215a6af875aa669e9d9a46c */}
