...
> **Layer**: Tier 2 — *verticals* (game-engine, automation)

---

## Overview

The `cfx-domain` module is a **workspace-root package** that organizes and coordinates *domain-specific verticals* within the CFX DevKit architecture. It does not contain executable logic itself, but serves as a structural container for independent, reusable TypeScript libraries:
