...
<StatusGrid columns={3}>
  <StatusItem icon={<CheckIcon />} label="Verified" />
  <StatusItem icon={<LockIcon />} label="Secure" />
...
<SegmentedControl
  ...
  onChange={(v) => setMode(v as 'swap' | 'wrap' | 'unwrap')}
/>
```
...
<Notice tone="warning">This action cannot be undone.</Notice>
<NetworkSwitchNotice
  expectedChainId="0x1"
  chainName="Ethereum Mainnet"
  message="Please switch to Ethereum to continue."
/>
```
...
<!-- api-hash: 3beb316658db3d747964f2bbe0d005a31bf9a61a6755d56a4aa1ab580866c278 -->
