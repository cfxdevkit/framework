> Closure note (2026-05-17): Archive this change as deferred/superseded. Section 1–2 landed in `@cfxdevkit/react`; the remaining showcase-local adoption tasks are intentionally not being pursued in the current release cleanup.
