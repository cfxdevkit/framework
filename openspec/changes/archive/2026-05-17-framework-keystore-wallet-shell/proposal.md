...
> Closure note (2026-05-17): Archive this change as deferred/superseded. The reusable keystore hooks/components landed in `@cfxdevkit/react`, but showcase-local adoption is not part of the current release plan. Future adoption should be scoped in a smaller targeted change if it is still desired.
