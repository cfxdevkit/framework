> Closure note (2026-05-17): Archive this change as already landed elsewhere. Do not treat the unchecked tasks below as pending implementation; the repo already uses the dual-address model they describe.
