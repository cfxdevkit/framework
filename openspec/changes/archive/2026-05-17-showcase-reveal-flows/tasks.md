> Closure note (2026-05-17): Archive this change as complete. The reveal routes and `RevealPanel` are live in `showcase-local`; any further cleanup belongs to `artifacts/plan/phase-1-showcase-local.md`.
