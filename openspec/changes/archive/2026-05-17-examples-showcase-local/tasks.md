> Closure note (2026-05-17): Archive this change as materially implemented. The backend-first workspace rewrite landed. The remaining unchecked matrix/validation work is now tracked in `artifacts/plan/phase-1-showcase-local.md`, not in this task list.
