...
> Closure note (2026-05-17): Archive this change as materially complete. `ui-core` and `ui` landed and are already being consumed. The remaining unchecked tasks were optional primitive polish and end-state review, not blockers for the current release wave.
