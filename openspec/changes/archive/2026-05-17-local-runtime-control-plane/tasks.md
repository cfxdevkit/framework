> Closure note (2026-05-17): Archive this change as materially landed/superseded. The runtime surface and extension hook exist today; the remaining unchecked items are broader consumer-convergence follow-up, not a clean pending implementation list.
