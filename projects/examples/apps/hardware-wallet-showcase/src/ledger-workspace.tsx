...
export function LedgerWorkspace(props: { wallet: WalletController }) {
  const { wallet } = props;
  return (
    <section className="workspace">
      ...
      <section className="panel">
        ...
        <div className="connection-strip">
          ...
          <span>
            {wallet.connected ? 'Ledger keystore signer connected' : 'Ledger keystore disconnected'}
          </span>
        ...
        <div className="operation-state-grid">
          ...
          <div>
            <span>Signer</span>
            <strong>Hardware approval</strong>
          </div>
        </div>
        ...
        <div className="actions">
          ...
          >
            {wallet.connected ? 'Disconnect signer' : 'Connect signer'}
          </button>
          <button
            type="button"
