...
This project is indexed by GitNexus as **framework** (186 symbols, 205 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
