...
This project is indexed by GitNexus as **framework** (9463 symbols, 20349 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
