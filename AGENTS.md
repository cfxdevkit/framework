...
This project is indexed by GitNexus as **framework** (13061 symbols, 22303 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
