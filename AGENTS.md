...
This project is indexed by GitNexus as **framework** (8403 symbols, 13444 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
