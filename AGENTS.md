...
This project is indexed by GitNexus as **framework** (14600 symbols, 22269 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
