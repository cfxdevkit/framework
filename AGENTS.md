...
This project is indexed by GitNexus as **framework** (17972 symbols, 27128 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
