...
This project is indexed by GitNexus as **framework** (11087 symbols, 17730 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
