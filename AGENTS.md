...
This project is indexed by GitNexus as **framework** (9576 symbols, 20652 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
