...
This project is indexed by GitNexus as **framework** (12741 symbols, 19720 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
